...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "auth.error.title": { en: "Authentication Error", ru: "Ошибка аутентификации", kk: "Аутентификация қатесі" },
  ...
  "new.field.description.placeholder": { en: "Provide specific details: what the issue is, exact location, severity, how many people are affected...", ru: "Укажите детали: суть проблемы, точное местоположение, серьёзность, количество затронутых людей...", kk: "Нақты мәліметтерді көрсетіңіз: мәселенің мәні, нақты орны, маңыздылығы, зардап шеккен адамдар саны..." },
